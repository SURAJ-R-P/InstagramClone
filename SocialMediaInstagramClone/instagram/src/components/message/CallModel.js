...
import Calling from '../../audio/call.mp3'
    ...
    useEffect(() => {
        socket.on('callerDisconnect', () => {
            ...
            dispatch({
                ...
                payload: {error: `The ${call.user_name} disconnect`} 
            })
        })
        ...
        <div className="call_model">
            <div className="call_box" style={{display: (answer && call.video) ? 'none' : 'flex'}}>
                <div className='text-center' style={{padding: '40px 0'}}>
                    <Avatar src={call.avatar} size="verybig-avatar" />
                    <h4>{call.user_name}</h4>
                    <h6>{call.full_name}</h6>
                        {
                            answer 
                            ? <div>
